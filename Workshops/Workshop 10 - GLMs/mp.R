...
eggs3$Development_category<-as.factor(eggs$Development_category)
...
#rerun the model using the untransformed data
model_eggs3u<-lm(eggs3$egg_mass~eggs3$female_mass*eggs3$Development_category)
anova(model_eggs3u)
summary(model_eggs3u)
