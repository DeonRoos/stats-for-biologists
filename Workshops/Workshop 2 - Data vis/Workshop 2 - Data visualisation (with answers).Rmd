...
p1 <- ggplot(abdn) +
  geom_histogram(aes(x = Price), fill = "#EC1365", colour = "white", binwidth = 50) +
...
p6 <- ggplot(abdn) +
  geom_violin(aes(x = Furnished, y = Price), fill = "#EC1365") +
  theme_classic() +
...
ggplot(abdn) +
  geom_point(aes(x = PublicRooms, y = FloorArea, colour = lat), shape = 24, size = 10, alpha = 1) +
  theme(
