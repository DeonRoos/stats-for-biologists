...
```{r, include=answer_sheet, class.source="bg-success", eval = F}
# Because this involves randomly generated numbers, your results will vary each time you run the code. However, there's a good chance that some of your generated values will be below zero, especially if you increase the standard 
# deviation. 
...
# Remember - residuals are the difference between what the model predict and what we observed. We can't check that until we've run the model. We can also check linearity after (but also with EDA) but there is no way to check the others
